...
[![osu!gaming CTF 2025 banner](osuctf.jpg)](https://osugaming.sekai.team/)

This was mine and [ra1n.xyz's](https://buggirls.xyz/) first ever CTF, and we were most definately feeling out of our depth for a while. Despite this and some unfortunate time constraints, we had lots of fun and hope you enjoy reading our attempts at solving the solutions. :3
...
![Caesar cipher website demonstration](crypto_rot727.png)
...
![alt text](crypto_beyond-wood0.png)
...
![Resulting image of running the program](crypto_beyond-wood1.png)
...
![ChatGPT's response to problem](crypto_xnor-xnor-xnor.png)
...
![Recovered file contents of the E01](forensics_map-dealer0.png)
...
![Recovered beatmap in osu!](forensics_map-dealer1.jpg)
...
![LonerPicture](osint_weebbolt_loner.png)
...
![DiaryPicture](osint_weebbolt_diary0.png)
...
![DiaryAlbum](osint_weebbolt_diary1.png)
...
![OngakuPicture](osint_weebbolt_ongaku.png)
...
![GhostPicture](osint_weebbolt_ghost.png)
...
![BenchPicture](osint_weebbolt_bench.png)
...
![PunchdrunkPicture](osint_weebbolt_punchdrunk.png)
...
![CafePicture](osint_weebbolt_cafe.png)
...
![RoePicture](osint_weebbolt_roe.png)
...
![Website showcase](web_human-benchmark0.png)
...
![Captcha Image](web_human-benchmark1.png)
...
![Human Benchmark results](web_human-benchmark2.png)
...
![Website showcase](web_blue-zenith.png)
